...
export class CategorieProduitEditAdminComponent extends AbstractEditController<CategorieProduitDto, CategorieProduitCriteria, CategorieProduitService>   implements OnInit {
