...
@Component({
  selector: 'app-mode-paiement-edit-admin',
  templateUrl: './mode-paiement-edit-admin.component.html'
})
export class ModePaiementEditAdminComponent extends AbstractEditController<ModePaiementDto, ModePaiementCriteria, ModePaiementService>   implements OnInit {
