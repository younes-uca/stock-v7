...
@Component({
  selector: 'app-etat-reception-create-admin',
  templateUrl: './etat-reception-create-admin.component.html'
})
export class EtatReceptionCreateAdminComponent extends AbstractCreateController<EtatReceptionDto, EtatReceptionCriteria, EtatReceptionService>  implements OnInit {
