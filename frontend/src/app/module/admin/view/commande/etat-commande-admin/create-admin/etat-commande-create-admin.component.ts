...
export class EtatCommandeCreateAdminComponent extends AbstractCreateController<EtatCommandeDto, EtatCommandeCriteria, EtatCommandeService>  implements OnInit {
